...
HD_PWD='D:/Chisel/chisel_dev/smart_nic_sim/smart_nic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpsoc_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mpsoc_wrapper.tcl
