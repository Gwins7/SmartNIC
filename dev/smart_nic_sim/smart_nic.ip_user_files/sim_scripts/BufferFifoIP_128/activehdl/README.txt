...
#
# Generated by export_simulation on Fri Mar 10 23:10:53 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './BufferFifoIP_128.sh' script.

./BufferFifoIP_128.sh -reset_run
...
./BufferFifoIP_128.sh -noclean_files

For more information on the script, please type './BufferFifoIP_128.sh -help'.
