...
#
# smart_nic_sim.xpr.tcl: Tcl script for re-creating project 'smart_nic'
#
# Generated by Vivado on Wed Apr 26 11:44:14 +0800 2023
...
#
# 1. This project restoration tcl script (smart_nic_sim.xpr.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "${origin_dir}/srcs/sim/imports/qdma_stm_defines.svh"
#    "${origin_dir}/srcs/sim/imports/qdma_stm_c2h_stub.sv"
#    "${origin_dir}/srcs/sim/imports/qdma_stm_h2c_stub.sv"
#    "${origin_dir}/srcs/sim/imports/mpsoc_wrapper.sv"
#    "${origin_dir}/srcs/sim/imports/package_handler.sv"
#    "${origin_dir}/srcs/sim/imports/qdma_fifo_lut.sv"
#    "${origin_dir}/srcs/sim/ip/axis_data_fifo_0/axis_data_fifo_0.xci"
#    "${origin_dir}/srcs/sim/ip/BufferFifoIP_128/BufferFifoIP_128.xci"
#    "${origin_dir}/srcs/sim/ip/BufferFifoIP_512/BufferFifoIP_512.xci"
#    "${origin_dir}/srcs/sim/imports/smartnic_sim.sv"
#
...
set _xil_proj_name_ "smart_nic_sim"
...
set script_file "smart_nic_sim.xpr.tcl"
...
set_property -name "ip_output_repo" -value "D:/Chisel/dev/smart_nic_sim/${_xil_proj_name_}.cache/ip" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "platform.board_id" -value "nf_card" -objects $obj
set_property -name "sim.central_dir" -value "D:/Chisel/dev/smart_nic_sim/${_xil_proj_name_}.ip_user_files" -objects $obj
...
set_property -name "webtalk.xsim_launch_sim" -value "528" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "${origin_dir}/srcs/sim/padding ${origin_dir}/srcs/sim/reset" $obj
...
# Set 'sources_1' fileset file properties for local files
set file "BufferFifoIP_128/BufferFifoIP_128.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "BufferFifoIP_512/BufferFifoIP_512.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "imports/smartnic_sim.sv"
...
set_property -name "top" -value "smartnic_sim" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu19eg-ffvc1760-2-e -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
