...
#
# smart_nic_dev.tcl: Tcl script for re-creating project 'smart_nic'
#
# Generated by Vivado on Wed Apr 26 11:36:56 CST 2023
...
#
# 1. This project restoration tcl script (smart_nic_dev.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "${origin_dir}/srcs/fpga/imports/qdma_stm_defines.svh"
#    "${origin_dir}/srcs/fpga/imports/qdma_fifo_lut.sv"
#    "${origin_dir}/srcs/fpga/imports/qdma_stm_c2h_stub.sv"
#    "${origin_dir}/srcs/fpga/imports/qdma_stm_h2c_stub.sv"
#    "${origin_dir}/srcs/fpga/imports/user_control.sv"
#    "${origin_dir}/srcs/fpga/imports/mpsoc_wrapper.sv"
#    "${origin_dir}/srcs/fpga/imports/package_handler.sv"
#    "${origin_dir}/srcs/fpga/imports/cmac_fifo.sv"
#    "${origin_dir}/srcs/fpga/ip/blk_mem_gen_0/blk_mem_gen_0.xci"
#    "${origin_dir}/srcs/fpga/ip/axis_data_fifo_0/axis_data_fifo_0.xci"
#    "${origin_dir}/srcs/fpga/ip/axis_data_fifo_1/axis_data_fifo_1.xci"
#    "${origin_dir}/srcs/fpga/imports/xilinx_qdma_pcie_x1y0.xdc"
#    "${origin_dir}/srcs/fpga/imports/top.xdc"
#
...
set _xil_proj_name_ "smart_nic_dev"
...
set script_file "smart_nic_dev.tcl"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xczu19eg-ffvc1760-2-e
...
set_property -name "board_part" -value "sugon:nf_card:part0:2.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "enable_vhdl_2008" -value "1" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/${_xil_proj_name_}.cache/ip" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "platform.board_id" -value "nf_card" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/srcs/fpga/padding"] [file normalize "$origin_dir/srcs/fpga/reset"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/srcs/fpga/imports/qdma_stm_defines.svh" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/qdma_fifo_lut.sv" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/qdma_stm_c2h_stub.sv" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/qdma_stm_h2c_stub.sv" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/user_control.sv" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/mpsoc_wrapper.sv" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/package_handler.sv" ]\
 [file normalize "${origin_dir}/srcs/fpga/imports/cmac_fifo.sv" ]\
]
...
set file "imports/mpsoc_wrapper.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "imports/package_handler.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "imports/cmac_fifo.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "mpsoc_wrapper" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/srcs/fpga/ip/blk_mem_gen_0/blk_mem_gen_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/srcs/fpga/ip/axis_data_fifo_0/axis_data_fifo_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/srcs/fpga/ip/axis_data_fifo_1/axis_data_fifo_1.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
set file "[file normalize "$origin_dir/srcs/fpga/imports/xilinx_qdma_pcie_x1y0.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "imports/xilinx_qdma_pcie_x1y0.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/srcs/fpga/imports/top.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *imports/top.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *imports/top.xdc]" -objects $obj
...
proc cr_bd_mpsoc { parentCell } {
  ...
  set QDMA_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 QDMA_axil ]
  ...
  set QDMA_c2h [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_eqdma:s_axis_c2h_rtl:1.0 QDMA_c2h ]

  set QDMA_c2h_cmpt [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_eqdma:s_axis_c2h_cmpt_rtl:1.0 QDMA_c2h_cmpt ]

  set QDMA_h2c [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_eqdma:m_axis_h2c_rtl:1.0 QDMA_h2c ]

  set QDMA_pcie_mgt [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:pcie_7x_mgt_rtl:1.0 QDMA_pcie_mgt ]
  ...
  # Create ports
  set CMAC_axi_aclk [ create_bd_port -dir O -type clk CMAC_axi_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {tx_axis} \
 ] $CMAC_axi_aclk
  set QDMA_axi_aclk [ create_bd_port -dir O -type clk QDMA_axi_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {QDMA_axil} \
   CONFIG.FREQ_HZ {250000000} \
 ] $QDMA_axi_aclk
  set QDMA_axi_aresetn [ create_bd_port -dir O -type rst QDMA_axi_aresetn ]
  set QDMA_soft_reset_n [ create_bd_port -dir I -type rst QDMA_soft_reset_n ]
  set QDMA_sys_clk [ create_bd_port -dir I -type clk QDMA_sys_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {QDMA_sys_rst_n} \
 ] $QDMA_sys_clk
  set QDMA_sys_clk_gt [ create_bd_port -dir I -type clk QDMA_sys_clk_gt ]
  set QDMA_sys_rst_n [ create_bd_port -dir I -type rst QDMA_sys_rst_n ]
  ...
  set rx_fifo_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst rx_fifo_aresetn ]
  set tx_fifo_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst tx_fifo_aresetn ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.RX_MAX_PACKET_LEN {2048} \
   CONFIG.TX_FLOW_CONTROL {0} \
   CONFIG.TX_FRAME_CRC_CHECKING {Enable FCS Insertion} \
   CONFIG.USER_INTERFACE {AXIS} \
 ] $cmac_usplus_0

  # Create instance: cmactz_user_reset, and set properties
  set cmactz_user_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 cmactz_user_reset ]
  ...
  # Create instance: rx_datapath_reset, and set properties
  set rx_datapath_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rx_datapath_reset ]

  # Create instance: rx_datapath_reset_cnt_0, and set properties
  set rx_datapath_reset_cnt_0 [ create_bd_cell -type ip -vlnv user.org:user:rx_reset_cnt:1.0 rx_datapath_reset_cnt_0 ]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] [get_bd_pins /rx_datapath_reset_cnt_0/gtwiz_rx_reset]

  # Create instance: tx_fifo_reset, and set properties
  set tx_fifo_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 tx_fifo_reset ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__SRCSEL {DPLL} \
  ...
  connect_bd_intf_net -intf_net qdma_0_M_AXI_LITE [get_bd_intf_ports QDMA_axil] [get_bd_intf_pins qdma_0/M_AXI_LITE]
  connect_bd_intf_net -intf_net qdma_0_m_axis_h2c [get_bd_intf_ports QDMA_h2c] [get_bd_intf_pins qdma_0/m_axis_h2c]
  connect_bd_intf_net -intf_net qdma_0_pcie_mgt [get_bd_intf_ports QDMA_pcie_mgt] [get_bd_intf_pins qdma_0/pcie_mgt]
  connect_bd_intf_net -intf_net s_axis_c2h_0_1 [get_bd_intf_ports QDMA_c2h] [get_bd_intf_pins qdma_0/s_axis_c2h]
  connect_bd_intf_net -intf_net s_axis_c2h_cmpt_0_1 [get_bd_intf_ports QDMA_c2h_cmpt] [get_bd_intf_pins qdma_0/s_axis_c2h_cmpt]
  ...
  connect_bd_net -net cmac_usplus_0_gt_txusrclk2 [get_bd_ports CMAC_axi_aclk] [get_bd_pins cmac_usplus_0/gt_txusrclk2] [get_bd_pins cmac_usplus_0/rx_clk] [get_bd_pins cmactz_user_reset/slowest_sync_clk] [get_bd_pins rx_datapath_reset/slowest_sync_clk] [get_bd_pins rx_datapath_reset_cnt_0/clk]
  connect_bd_net -net cmac_usplus_0_stat_rx_status [get_bd_pins cmac_usplus_0/stat_rx_status] [get_bd_pins rx_datapath_reset_cnt_0/rx_status]
  connect_bd_net -net cmac_usplus_0_usr_rx_reset [get_bd_pins cmac_usplus_0/usr_rx_reset] [get_bd_pins cmactz_user_reset/ext_reset_in]
  ...
  connect_bd_net -net doce_ic_reset_peripheral_reset [get_bd_pins rx_datapath_reset/peripheral_reset] [get_bd_pins rx_datapath_reset_cnt_0/reset]
  ...
  connect_bd_net -net pl_clk2_out [get_bd_pins cmac_usplus_0/drp_clk] [get_bd_pins cmac_usplus_0/init_clk] [get_bd_pins pl_clk_sys_reset/slowest_sync_clk] [get_bd_pins zynq_mpsoc/pl_clk2]
  connect_bd_net -net pl_resetn0 [get_bd_pins pl_clk_sys_reset/ext_reset_in] [get_bd_pins rx_datapath_reset/ext_reset_in] [get_bd_pins zynq_mpsoc/pl_resetn0]
  connect_bd_net -net qdma_0_axi_aclk [get_bd_ports QDMA_axi_aclk] [get_bd_pins qdma_0/axi_aclk] [get_bd_pins tx_fifo_reset/slowest_sync_clk]
  connect_bd_net -net qdma_0_axi_aresetn [get_bd_ports QDMA_axi_aresetn] [get_bd_pins qdma_0/axi_aresetn] [get_bd_pins tx_fifo_reset/ext_reset_in]
  connect_bd_net -net rx_datapath_reset1_peripheral_aresetn [get_bd_ports tx_fifo_aresetn] [get_bd_pins tx_fifo_reset/peripheral_aresetn]
  connect_bd_net -net rx_reset_cnt_0_gtwiz_rx_reset [get_bd_pins cmac_usplus_0/gtwiz_reset_rx_datapath] [get_bd_pins rx_datapath_reset_cnt_0/gtwiz_rx_reset]
  connect_bd_net -net soft_reset_n_0_1 [get_bd_ports QDMA_soft_reset_n] [get_bd_pins qdma_0/soft_reset_n]
  connect_bd_net -net sys_clk_0_1 [get_bd_ports QDMA_sys_clk] [get_bd_pins qdma_0/sys_clk]
  connect_bd_net -net sys_clk_gt_0_1 [get_bd_ports QDMA_sys_clk_gt] [get_bd_pins qdma_0/sys_clk_gt]
  connect_bd_net -net sys_rst_n_0_1 [get_bd_ports QDMA_sys_rst_n] [get_bd_pins qdma_0/sys_rst_n]
  connect_bd_net -net tx_reset_peripheral_aresetn [get_bd_ports rx_fifo_aresetn] [get_bd_pins cmactz_user_reset/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces qdma_0/M_AXI_LITE] [get_bd_addr_segs QDMA_axil/Reg] -force
...
# End of cr_bd_mpsoc()
cr_bd_mpsoc ""
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files mpsoc.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files mpsoc.bd ] 

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu19eg-ffvc1760-2-e -flow {Vivado Synthesis 2020} -strategy "Flow_AlternateRoutability" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu19eg-ffvc1760-2-e -flow {Vivado Implementation 2020} -strategy "Flow_RunPostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
if {[string equal [get_runs -quiet impl_1_copy_1] ""]} {
    create_run -name impl_1_copy_1 -part xczu19eg-ffvc1760-2-e -flow {Vivado Implementation 2020} -strategy "Flow_RunPostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
