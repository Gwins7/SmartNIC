...
module mpsoc_wrapper
   (
    ...
    input [31:0] c2h_match_arg4,
    input [31:0] c2h_match_arg5,
    input [31:0] c2h_match_arg6,
    input [31:0] c2h_match_arg7,
    input [31:0] c2h_match_arg8,
    input [31:0] c2h_match_arg9,
    input [31:0] c2h_match_arg10,
    input [31:0] c2h_match_arg11,
    input [31:0] c2h_match_arg12,
    input [31:0] c2h_match_arg13,
    input [31:0] c2h_match_arg14,
    input [31:0] c2h_match_arg15,
    input reset_counter
    );
