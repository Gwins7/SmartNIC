...
#
# Generated by export_simulation on Fri Mar 10 23:10:24 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './BufferFifoIP_512.sh' script.

./BufferFifoIP_512.sh -reset_run
...
./BufferFifoIP_512.sh -noclean_files

For more information on the script, please type './BufferFifoIP_512.sh -help'.
