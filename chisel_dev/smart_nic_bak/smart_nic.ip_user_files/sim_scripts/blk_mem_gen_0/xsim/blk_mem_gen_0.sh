...
#
# Generated by Vivado on Thu Sep 08 11:17:38 CST 2022
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mpsoc.protoinst" -protoinst "protoinst_files/mpsoc.protoinst" -log simulate.log
}
