...
xvlog_opts="--relax -L cmac_usplus_v3_1_0 -L qdma_v4_0_0 -L axi_vip_v1_1_7 -L zynq_ultra_ps_e_vip_v1_0_7 -L xilinx_vip"
xvhdl_opts="--relax"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axis_infrastructure_v1_1_0 -L axis_data_fifo_v2_0_3 -L xil_defaultlib -L xlconstant_v1_1_7 -L gtwizard_ultrascale_v1_7_8 -L cmac_usplus_v3_1_0 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_7 -L zynq_ultra_ps_e_vip_v1_0_7 -L qdma_v4_0_0 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mpsoc xil_defaultlib.mpsoc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mpsoc -key {Behavioral:sim_1:Functional:mpsoc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3194.protoinst" -protoinst "protoinst_files/mpsoc.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mpsoc.wdb xsim.dir)
