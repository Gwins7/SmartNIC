...
module mpsoc_wrapper
  ...
  input QDMA_c2h_cmpt_no_wrb_marker;
  ...
  wire QDMA_c2h_cmpt_no_wrb_marker;
  ...
  mpsoc mpsoc_i
       (.CMAC_in_tdata(CMAC_in_tdata),
        ...
        .QDMA_c2h_cmpt_no_wrb_marker(QDMA_c2h_cmpt_no_wrb_marker),
